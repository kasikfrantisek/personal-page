...
export const About = () => {
    return (
        <div className="w-full h-screen snap-start span-always text-white md:pt-28 md:py-28 pt-10 px-5 relative overflow-hidden">
